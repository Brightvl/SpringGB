...
public class Application {
     ...
     * <p>
     * Пример: TicketNumberGenerator generator = context.getBean(TicketNumberGenerator.class);
     ...
     * <p>
     * 3. Класс "Табло" - бин (синглтон), у которого есть поле ticketNumberGenerator и метод метод newTicket(), который
     * создает объект класса Ticket с значениями полей:
    ...
    public static void main(String[] args) {
        ...
        System.out.println(displayBoard.newTicket());
        System.out.println(displayBoard.newTicket());
        System.out.println(displayBoard.newTicket());
    }
}
